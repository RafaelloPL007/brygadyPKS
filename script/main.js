...
function getAllTrips() {
  $.ajax({
    type: "GET",
    url: "script/json/" + urlBase + "trips.json?v=25-03-23v19",
    dataType: "json"
  }).done(function (data) {
...
function pobierzRezerwy() {
  $.ajax({
    type: "GET",
    url: "script/json/" + urlBase + "rezerwy.json?v=25-03-23v19",
    dataType: "json"
  }).done(function (data) {
...
function getLines(skip) {
  $.ajax({
    type: "GET",
    url: "script/json/" + urlBase + "lines.json?v=25-03-23v19",
    dataType: "json",
  }).done(function (data) {
    data.forEach((e) => {
...
function getRoutes() {
  $.ajax({
    type: "GET",
    url: "script/json/" + urlBase + "routesDist.json?v=25-03-23v19",
    dataType: "json"
  }).done(function (data) {
    data.forEach((e) => {
      arrayOfRoutes.push(
...
function getVehicleList() {
  $.ajax({
    type: "GET",
    url: "script/json/" + urlBase + "vehicles.json?v=25-03-23v19",
    dataType: "json",
  }).done(function (data) {
    vehicleList = data;
    refreshVehArray();
...
function getPKSTrips() {
  $.ajax({
    type: "GET",
    url: "script/json/" + urlBasePKS + "trips.json?v=25-03-23v19",
    dataType: "json"
  }).done(function (trips) {
    $.ajax({
      type: "GET",
      url: "script/json/" + urlBasePKS + "tripDetails.json?v=25-03-23v19",
      dataType: "json"
