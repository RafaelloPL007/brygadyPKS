...
if (ttidPKS == "24-03-01") {
  ...
  urlBasePKS += "25-09-01/";
} else if (ttidPKS == "25-09-05") {
  urlBasePKS += "25-09-05/";
} else if (ttidPKS == "25-10-13" || ttidPKS == "null" || ttidPKS == undefined) {
  urlBasePKS += "25-10-13/";
  isCurrentTTPKS = true;
}
...
function sortServicesPKS(a, b) {
  ...
  const brygOrder = ['1', '2', 'R2', '3', 'A3', 'R3', '3ŚR', 'R3ŚR', '4', 'R4', '4PT', 'R4PT', '5', '6', '+', 'AB6', 'C6', 'CD6', 'D', '+A', '+B', '+AB', '+C', 'S'];
...
function getAllTrips() {
  $.ajax({
    type: "GET",
    url: "script/json/" + urlBase + "trips.json?v=25-03-23v24",
    dataType: "json"
  }).done(function (data) {
...
function pobierzRezerwy() {
  $.ajax({
    type: "GET",
    url: "script/json/" + urlBase + "rezerwy.json?v=25-03-23v24",
    dataType: "json"
  }).done(function (data) {
...
function getLines(skip) {
  $.ajax({
    type: "GET",
    url: "script/json/" + urlBase + "lines.json?v=25-03-23v24",
    dataType: "json",
  }).done(function (data) {
    data.forEach((e) => {
...
function getRoutes() {
  $.ajax({
    type: "GET",
    url: "script/json/" + urlBase + "routesDist.json?v=25-03-23v24",
    dataType: "json"
  }).done(function (data) {
    data.forEach((e) => {
      arrayOfRoutes.push(
...
function getVehicleList() {
  $.ajax({
    type: "GET",
    url: "script/json/" + urlBase + "vehicles.json?v=25-03-23v24",
    dataType: "json",
  }).done(function (data) {
    vehicleList = data;
    refreshVehArray();
...
function getPKSTrips() {
  $.ajax({
    type: "GET",
    url: "script/json/" + urlBasePKS + "trips.json?v=25-03-23v24",
    dataType: "json"
  }).done(function (trips) {
    $.ajax({
      type: "GET",
      url: "script/json/" + urlBasePKS + "tripDetails.json?v=25-03-23v24",
      dataType: "json"
